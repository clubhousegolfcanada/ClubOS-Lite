...
class ResponseToneLLM:
    def __init__(self):
        self.name = "ResponseToneLLM"
        self.prompt = """Rewrite all responses to match Clubhouse tone: dry, sharp, direct."""
        self.doc = "backend/documents/tone_rules.md"
        self.chunks = []
        self.reload()
